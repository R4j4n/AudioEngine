...
class AudioScheduler:
    def __init__(self):
        print("=" * 60)
        print("AUDIO SCHEDULER - INITIALIZATION")
        print("=" * 60)
    ...
    def run(self):
        """Run the scheduler"""
        print("\n" + "=" * 60)
        print("AUDIO SCHEDULER - STARTING")
        print("=" * 60)
...
if __name__ == "__main__":
    try:
        ...
        traceback.print_exc()
        print("\nPlease check:")
        print("  1. All audio files exist in AudioFiles/ folder")
        ...
        print("  5. mapping.py is configured correctly")
        print("=" * 60)
